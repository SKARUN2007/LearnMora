...
const PATHS = [
  ...
  { id: "data-science", title: "Data Science & ML", icon: <BarChart size={24} />, count: "950+ Courses", image: "https://images.unsplash.com/photo-1518186285589-2f7649de83e0?auto=format&fit=crop&q=80&w=800" },
  ...
  { id: "marketing", title: "Digital Marketing", icon: <Share2 size={24} />, count: "700+ Courses", image: "https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?auto=format&fit=crop&q=80&w=800" },
  { id: "health", title: "Health & Medicine", icon: <Stethoscope size={24} />, count: "550+ Courses", image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=800" },
  { id: "finance", title: "Finance & Fintech", icon: <Landmark size={24} />, count: "480+ Courses", image: "https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?auto=format&fit=crop&q=80&w=800" },
